...
%BH?  „ерна€ ƒыра 
TiDi=2;%0;1;2;
ste=1;%1;2;3;4;5;6;%ste=4 только дл€ imI='850kZ.jpg';
wd=1;%=0,1,2;

imI='104kZ.png'; im1='104kF.bmp';imB='104kZB.bmp';
%imI='104kF.bmp'; im0='104kf0.bmp';

iP=imread(imI,'png');FimP('iP в исходной сетке ',iP,1);
...
coY=5; coX=190; szY=421;szX=421;%for 850kF;%ste=4;
