...
uicontrol(gcf,'Style','text','BackgroundColor',[0.0 0.7 0.0],'Position',[20 10 400 200],...
    ...
    'String',{'Road Sign', 'in Image'});drawnow;
...
I0=Lo;J0=Lo;m=47    %31;41;                                     %1;3;5;21;Lo=35
...
s=snPfIe(diP,g,0);
%s=cSuGr3I(ag,[0.15,0.65,0.80],0);
%s=cSuGr3I(a,[0.15,0.65,0.80],0);
maD(i,j)=+s;
    end
end
%FimP('d',d,TiDi);
