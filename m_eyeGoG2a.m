...
wd=0.15;pr=0.55;pnd=0;%0;1;%R %*****************
%wd=0.20;pr=0.25;pnd=0;%0;1;%L%*****************

pF=0.95;%0.3;0.6;1.2;%Оставляем НЧ и pF =0.55 и выше обнуляем
